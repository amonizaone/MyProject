...
{
    public class LineBot: WebhookApplication
    {
        private readonly string channelToken = "f37433eb5c19924b4fdbf4670aa71a40";
        private LineMessagingClient lineMessagingClient { get; set; }
        public LineBot()
        {
            lineMessagingClient = new LineMessagingClient(channelToken);
                // new LineMessagingClient(Environment.GetEnvironmentVariable("CHANNEL_ACCESS_TOKEN")); ;
        }
